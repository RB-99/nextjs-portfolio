...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className='w-full flex flex-col h-screen'>
            ...
            <Link className='text-zinc-200 flex font-semibold w-full border-0 min-w-full sticky m-auto align-bottom h-10 bg-gradient-to-l from-zinc-700 to-zinc-800 hover:from-zinc-600 hover:to-zinc-800' href="/">
